...
LRESULT CALLBACK adminWindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        CreateWindowW(L"button", L"Créer un compte", WS_BORDER | WS_VISIBLE | WS_CHILD, 200, 150, 200, 40, hWnd, (HMENU)ID_BUTTON_ACCOUNT_CREATE, NULL, NULL);
        ...
        CreateWindowW(L"button", L"Créer une partie", WS_BORDER | WS_VISIBLE | WS_CHILD, 200, 250, 200, 40, hWnd, (HMENU)ID_BUTTON_GAME_CREATE, NULL, NULL);
